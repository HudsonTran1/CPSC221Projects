...
public class ListTester {
	...
	private void runTests() {
		...
		//2-element to empty list
			// Scenario: 47
		testEmptyList(AB_iterNextRemoveNextRemove_EMPTY, "AB_iterNextRemoveNextRemove_EMPTY");
		...
		//3-element to empty list
			// Scenario: 54
		testEmptyList(ABC_iterNextRemoveNextRemoveNextRemove_EMPTY, "ABC_iterNextRemoveNextRemoveNextRemove_EMPTY");
		...
		if (SUPPORTS_LIST_ITERATOR) {
			...
			// Scenario 66
			testEmptyList(A_listIter1PreviousRemove_emptyList, "A_listIter1PreviousRemove_emptyList");
			...
			// Scenario 99
			testThreeElementList(ABC_listIter2PreviousSetD_ADC, "ABC_listIter2PreviousSetD_ADC", LIST_ADC, STRING_ADC);
		}
	 ...
	 */
	private IndexedUnsortedList<Integer> AB_iterNextRemoveNextRemove_EMPTY() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		Iterator<Integer> iter = list.iterator();
		iter.next();
		iter.remove();
	...
	private Scenario<Integer> AB_iterNextRemoveNextRemove_EMPTY = () -> AB_iterNextRemoveNextRemove_EMPTY();
	 ...
	 */
	private IndexedUnsortedList<Integer> ABC_iterNextRemoveNextRemoveNextRemove_EMPTY() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		list.addToRear(ELEMENT_C);
		Iterator<Integer> iter = list.iterator();
		iter.next();
	 ...
	 */
	private IndexedUnsortedList<Integer> AB_listIter1NextRemove_A() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
	 ...
	 */
	private IndexedUnsortedList<Integer> ABC_listIter1NextRemove_AC() {
		IndexedUnsortedList<Integer> list = AB_addAfterCB_ABC();
		ListIterator<Integer> listIter = list.listIterator(1);
		listIter.next();
		listIter.remove();
	...
	// Scenario 66
	private IndexedUnsortedList<Integer> A_listIter1PreviousRemove_emptyList() {
	...
	private Scenario<Integer> A_listIter1PreviousRemove_emptyList = () -> A_listIter1PreviousRemove_emptyList();
	 ...
	 */
	private IndexedUnsortedList<Integer> AB_listIter0NextAddC_ACB() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
	...
	// Scenario 99
	private IndexedUnsortedList<Integer> ABC_listIter2PreviousSetD_ADC() {
		IndexedUnsortedList<Integer> list = AB_addAfterCB_ABC();
		ListIterator<Integer> itr = list.listIterator(2);
		itr.previous();
		itr.set(ELEMENT_D); // [D, B, C]
		return list;
	}
	private Scenario<Integer> ABC_listIter2PreviousSetD_ADC = () -> ABC_listIter2PreviousSetD_ADC();
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			//[1/5]
			printTest(scenarioName + "_testAddToFrontX", testAddToFront(scenario.build(), ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddToRearX", testAddToRear(scenario.build(), ELEMENT_X, Result.NoException));
			...
			printTest(scenarioName + "_testAddAfter" + contentsString.charAt(0), testAddAfter(scenario.build(), contents[0], ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAfter", testAddAfter(scenario.build(), ELEMENT_X, ELEMENT_Z, Result.NoSuchElement));
			printTest(scenarioName + "_testAdd", testAdd(scenario.build(), ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAtIndexNeg1", testAddAtIndex(scenario.build(), -1, ELEMENT_X, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testAddAddAtIndex0", testAddAtIndex(scenario.build(), 0, ELEMENT_X, Result.NoException));

			//test by @Ponygator [2/5]
			printTest(scenarioName + "_testAddAtIndex1", testAddAtIndex(scenario.build(), 1, ELEMENT_X, Result.NoException));
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_testAddAfterZ", testAddAfter(scenario.build(), ELEMENT_Z, ELEMENT_X, Result.NoSuchElement));
			printTest(scenarioName + "_testAdd", testAdd(scenario.build(), ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAtIndexNeg1", testAddAtIndex(scenario.build(), -1, ELEMENT_X, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testAddAtIndex0", testAddAtIndex(scenario.build(), 0, ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAtIndex1", testAddAtIndex(scenario.build(), 1, ELEMENT_X, Result.NoException));
